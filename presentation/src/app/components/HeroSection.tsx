import { GreyoEyebrow, GreyoShell } from '@greyo-frontend/design-system';
import type { HeroContent } from '@greyo-frontend/entities';
...
export function HeroSection({ hero }: HeroSectionProps) {
  return (
    ...
    >
      <GreyoShell>
        <div className="py-24">
          <GreyoEyebrow label={hero.eyebrow} />
          ...
          <p className="mt-12 text-[clamp(22px,2.9vw,40px)] font-bold tracking-[-0.02em] text-white">
            <span className="text-greyo-orange">{hero.tagline.accent}</span>
            {hero.tagline.rest}
          </p>
