...
import type { EssenceContent } from '@greyo-frontend/entities';
...
export function BrandEssenceSection({ content }: BrandEssenceSectionProps) {
  return (
        ...
        <GreyoReveal>
          <div className="mt-5 flex flex-col gap-3 rounded-panel bg-greyo-ink px-7 py-6 sm:flex-row sm:items-center sm:justify-between sm:gap-8">
            <p className="text-[clamp(15px,1.5vw,19px)] font-bold text-white">
              ...
              <span className="text-greyo-orange">{content.banner.accent}</span>
            </p>
